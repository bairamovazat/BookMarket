...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a class="navbar-brand" href="<@spring.url "/"/>common/main"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="128" height="80" viewBox="0 0 128 80">
    ...
    <h4 class="text-white text-center d-none d-md-block">Тот<br>книжный магазин</h4>
    <form class="form-inline" style="width: 60%;padding-left: 1%;">
        <input class="form-control mr-sm-0" style="width: 80%; " type="search" placeholder="Search" aria-label="Search">
