    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-10 col-lg-8 col-xs-6">
            <div style="text-align: center">
                <h2>Категории книг <a href="create"><button class="btn btn-sm btn-primary">+</button></a></h2>
            </div>
            <table class="table table-striped">
                ...
                <tr>
                    <th scope="row"><a href="${'create?id=' + category.id}">${category.id!}</a></th>
                    <td>${category.name?html}</td>
                    <td><a href="${'create?id=' + category.id}">Изменить</a></td>
                </tr>
                </#list>
                </tbody>
            </table>
