    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-10 col-lg-8 col-xs-6">
            ...
            <form action="" method='POST'>
                ...
                <div class="form-group">
                    <label for="inputName">Введите название издателя</label>
                    <input name="name" class="form-control" id="inputName" placeholder="Имя"
                           value="${model.publisher???then(model.publisher.name?html, "")}"/>
                </div>

                <div class="form-group">
                    <input type="submit" value="${model.publisher???then("Изменить", "Добавить")}" class="form-control"
                           id="inputSubmit"/>
                </div>
            </form>
        </div>
