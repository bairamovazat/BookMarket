            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="/web_war_exploded/resources/image/slide1.jpg" alt="Первый слайд">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/web_war_exploded/resources/image/slide2.jpg" alt="Второй слайд">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/web_war_exploded/resources/image/slide3.jpg" alt="Третий слайд">
                    </div>
                </div>
                ...
                <div class="card" STYLE="padding-left: 2%">
                    <div class="center-block" style="width: 100%;height: auto">
                        <a href="#">
                            <img class="card-img-top"
                                 ...
                                 src="/web_war_exploded/resources/image/picture.jpg">
                        </a>
                    </div>
                    <div class="card-body">
                        1000 ₽
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div style="vertical-align: baseline;">Книга</div>
                        </li>
                        <li class="list-group-item">
                            <div class="font-weight-light"
                                 style="font-size: 14px;vertical-align: baseline;">Букиничный</div>
                        </li>
                        <li class="list-group-item">
                            <div class="font-weight-light" style="font-size: 12px;">Буки</div>
                        </li>
                    </ul>
