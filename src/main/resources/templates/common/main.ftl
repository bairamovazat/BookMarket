            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="/web/resources/image/slide1.jpg" alt="Первый слайд">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/web/resources/image/slide2.jpg" alt="Второй слайд">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/web/resources/image/slide3.jpg" alt="Третий слайд">
                    </div>
                </div>
                    ...
                    <div class="center-block" style="width: 100%;height: auto">
                        <a href="#">
                            <img class="card-img-top"
                                 ...
                                 src="/web/resources/image/picture.jpg">
                        </a>
                    </div>
                    <div class="card-body">
                        1000 ₽
